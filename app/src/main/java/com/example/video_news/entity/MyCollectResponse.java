package com.example.video_news.entity;
...
public class MyCollectResponse implements Serializable {
    ...
    private String msg;
    private int code;
    private List<com.example.video_news.entity.VideoEntity> list;
    ...
    public List<com.example.video_news.entity.VideoEntity> getList() {
        return list;
    }

    public void setList(List<com.example.video_news.entity.VideoEntity> list) {
        this.list = list;
    }
}
